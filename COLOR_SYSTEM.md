...
| `surface` | White | `#FFFFFF` | Card surfaces (with border `#E8E0D8`) |
...
|---|---|---|---|
| `onBackground` | Near Black | `#1E1218` | Headings, activity names, main content |
| `onSurface` | Deep Rose | `#4A2C38` | Dates, times, metadata |
